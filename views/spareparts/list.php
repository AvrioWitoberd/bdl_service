...
$offset = ($page - 1) * $limit;
$search = $_GET['search'] ?? '';
$msg = $_GET['msg'] ?? ''; // Ambil pesan dari URL jika ada
...
<head>
    ...
    <title>Daftar Spare Part - Service ABC</title>
        ...
        <div id="content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
                <div>
                    ...
                    <span class="text-muted small">Kelola stok dan harga suku cadang</span>
                </div>
            </div>
                            ...
                            <form method="GET" class="d-flex">
                                <div class="input-group shadow-sm rounded-pill overflow-hidden">
                                    <input type="text" name="search" class="form-control border-0 ps-4 bg-light"
                                        placeholder="Cari spare part..." value="<?= htmlspecialchars($search) ?>">
                                ...
                                <?php else: ?>
                                    <?php foreach ($spareparts as $s): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="fw-bold text-dark"><?= htmlspecialchars($s['nama_sparepart']) ?>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span
                                                    class="badge bg-light-info border border-primary border-opacity-10 px-3 py-2 rounded-pill">
                                                    <?= $s['stok'] ?> Unit
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="text-secondary small text-uppercase fw-bold"><?= htmlspecialchars($s['merek']) ?></span>
                                            </td>
