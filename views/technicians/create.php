...
<head>
    ...
    <title>Tambah Teknisi - Service ABC</title>
    ...
    <style>
        ...
        .form-section-title { font-size: 0.9rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #adb5bd; margin-bottom: 1rem; border-bottom: 1px solid #f1f1f1; padding-bottom: 0.5rem; }
        ...
        .input-group:focus-within { box-shadow: 0 0 0 0.25rem rgba(93, 135, 255, 0.25); border-radius: 0.375rem; }
        .input-group:focus-within .input-group-text, .input-group:focus-within .form-control { border-color: #86b7fe; background-color: #fff; }

        .btn-primary-custom { background-color: var(--accent-blue); border-color: var(--accent-blue); color: white; padding: 10px 25px; font-weight: 600; }
        .btn-primary-custom:hover { background-color: #4a72e8; border-color: #4a72e8; box-shadow: 0 4px 10px rgba(93, 135, 255, 0.3); }
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3 pt-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="status_aktif" name="status_aktif" value="1" <?php if ($isActive)
                                            echo 'checked'; ?>>
